 ...
 * <pre>
 */
package game.common.persist.jdbc;
...
import game.common.exception.DataOperationException;
import game.common.persist.PersistProvider;
import game.common.persist.jdbc.SQLUtil.DriverName;
import game.common.persist.query.DynamicQuery;
import game.common.persist.query.SearchResult;
import game.common.persist.query.SqlResult;
 ...
 *	&lt;EntityConfig entityName="game.common.dao.entity.AnteGame" primaryKey="gameId" tableName="AnteGame" /&gt;
 * &lt;/Entity&gt;
 * 调用示例:
 * <code>
