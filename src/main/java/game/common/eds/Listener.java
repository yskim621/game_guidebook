 ...
 * <pre>
 */
package game.common.eds;

import static game.common.eds.Listener.InstanceType.NEW;
...
public @interface Listener
{
	 ...
	 */
	InstanceType create() default InstanceType.NEW;
	...
	/**
	 * @return 获取实例的工厂方法，当create方式为{@link game.common.eds.Listener.InstanceType.FACTORY}，将通过工厂方法创建
	 */
	String factory() default "";

	/**
	 * @return 获取实例的Spring应用上下文Bean名称，当create方式为{@link game.common.eds.Listener.InstanceType.CONTEXT}
	 *         ，将通过Bean名称获取
	 */
